...
describe("'Realizar ingreso a Movie ART a listar a Actores'", function () {
    ...
    beforeEach('Realizar ingreso a Movie ART a listar a Director', () => {
        login.navegate();
        ...
        cy.url().then(url => {
            if (url.includes('Director')) {
                ...
                console.log("La URL actual contiene Director");
            } else {
                // La URL actual no contiene "actor"
                console.log("La URL actual no contiene Director");
            }
        })
...
describe("Cypress POM Test Suite", function () {
  ...
  it('Then I get a Director', () => {
    ...
    cy.get('.p-datatable-thead > .ng-star-inserted > :nth-child(1)').should('contain','Nombre')
